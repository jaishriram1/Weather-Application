...
const show = document.querySelector(".bbb");
...
const imama = document.querySelector(".iim3");
...
const imageComing1 = document.querySelector(".iim1");
const imageComing2 = document.querySelector(".iim2");
...
function showError(error) {
  switch (error.code) {
    case error.PERMISSION_DENIED:
      ...
      imageComing1.classList.add("active");
      imageComing2.classList.add("active");
      break;
